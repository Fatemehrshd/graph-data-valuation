...
ratio = 3
directory = 'value/'
pattern = re.compile(r'^PubMed_(\d+)_10_0_0\.5_0\.7_pc_value\.pkl$')
...
with open(os.path.join(path, f'node_drop_large_winter_value_{group_trunc_ratio_hop_1}_{group_trunc_ratio_hop_2}_{counter}_pubmed_test.pkl'), 'wb') as file:
    pickle.dump(win_acc, file)

with open(os.path.join(path, f'node_drop_large_winter_value_{group_trunc_ratio_hop_1}_{group_trunc_ratio_hop_2}_{counter}_pubmed_vali.pkl'), 'wb') as file:
